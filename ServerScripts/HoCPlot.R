...
plot(maindtL[,1],log(meanGVL),type='l',xlab="Generation Number",ylab="Genic Variance",xlim=c(8000,10000),ylim=c(-5,-2),col=pcol[1],lwd=1.5,cex.lab=1.5,cex.axis=1.5,yaxt="n")
axis(2,at=seq(-5,-2,0.5),labels=sprintf("%.3f",exp(seq(-5,-2,0.5))),cex.axis=1.5)
lines(maindtS[,1],log(meanGVS),col=pcol[2],lwd=1.5)
...
legend("right",legend=c("Baseline mutation rate","10-fold lower mutation rate"),lty=1,lwd=1.5,col=pcol[1:2],cex=1.5)
dev.off()
