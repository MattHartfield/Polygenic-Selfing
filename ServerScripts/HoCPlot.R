...
plot(maindtL[,1],log(meanGVL),type='l',xlab="Generation Number",ylab="Log Mean Genic Variance",xlim=c(8000,10000),ylim=c(-5,-2),col=pcol[1],lwd=1.5,cex.lab=1.5,cex.axis=1.5)
...
legend("right",legend=c("Baseline mutation rate","10-fold lower"),lty=1,lwd=1.5,col=pcol[1:2])
dev.off()
