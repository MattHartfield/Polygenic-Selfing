...
do
	...
	then
		...
		for i in $(seq 1 50)
		do
			echo "0" >> /scratch/mhartfield/polyself_out/plots/haps/HS_${fname}_s${SEL}_h${DOM}_self${SELF}_nt${NTR}_newo${NEWOP}_msd${MSD}.count
		done
	fi
done
