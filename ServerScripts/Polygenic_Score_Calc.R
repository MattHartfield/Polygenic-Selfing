...
title <- ggdraw() + draw_label(paste0("Polygenic score of sample",midh1,"\n",endh1,endp,endpb),fontface="bold",x=0,hjust=0,size=24)
opA <- plot_grid(op1 + theme(legend.position="none"),op2 + theme(legend.position="none"),op3 + theme(legend.position="none"),op4 + theme(legend.position="none"))
